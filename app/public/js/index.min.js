(function () {
	...
	*/
	...
	function Book(props) {
	  return react.createElement("div", {
	  ...
	  }, props.title, react.createElement(GoTrashcan, {
	    ...
	    className: "col-sm-3"
	  }, "isbn"), react.createElement("dd", {
	    className: "col-sm-9"
	  }, props.isbn)))));
	}

	function Books(props) {
	  return react.createElement(react.Fragment, null, props.data.map(book => react.createElement(Book, {
	    key: book.id,
	    title: book.title,
	    author: book.author,
	    isbn: book.isbn,
	...
	*/
	...
	class BookForm extends react.Component {
	  ...
	  formValid() {
	    ...
	    return this.isbnValid(isbn) && this.authorValid(author) && this.titleValid(title);
	  }

	  render() {
	    const submitClasses = classnames('btn', 'btn-primary', 'mb-2', {
	      'disabled': !this.formValid()
	    });
	    return react.createElement(react.Fragment, null, react.createElement("form", {
	      className: "m-3",
	      onSubmit: this.handleSubmit
	    }, react.createElement(FormInputField, {
	      name: "title",
	      value: this.state.book.title,
	      onChange: this.handleFormChange,
	      isValid: () => this.titleValid(this.state.book.title),
	      invalidReason: "Title can't be empty."
	    }, "Title"), react.createElement(FormInputField, {
	      name: "author",
	      value: this.state.book.author,
	      onChange: this.handleFormChange,
	      isValid: () => this.authorValid(this.state.book.author),
	      invalidReason: "Author can't be empty."
	    }, "Author"), react.createElement(FormInputField, {
	      name: "isbn",
	      ...
	      onChange: this.handleFormChange
	    }, "ISBN"), react.createElement("button", {
	      type: "submit",
	...
	class Root extends react.Component {
	  ...
	  componentWillMount() {
	    fetch('http://localhost:9292/books').then(response => response.json()).then(data => this.setState({
	      books: data
	    }));
	  }
